...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(255, 145, 66, 0.35)', // Adjusted to Amber Accent (#ff9142)
  gradientTo = 'rgba(74, 71, 68, 0.25)',    // Adjusted to Border Hairline (#4a4744)
  glowColor = '#ff914222',                 // Soft Amber Glow
  ...rest
}: DotFieldProps) => {
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      if (!ctx) return; if (!ctx) return; ctx.clearRect(0, 0, w, h);
