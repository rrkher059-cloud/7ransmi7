...
const DotField = memo(function DotField({
  // Defaults tuned to Departure Mono dark HUD (amber accent #ff9142)
  dotRadius = 1.5,
  dotSpacing = 14,
  cursorRadius = 500,
  cursorForce = 0.1,
  ...
  useEffect(() => {
    ...
    function doResize() {
      ...
      const w = Math.max(parent.clientWidth, rect.width, 1)
      const h = Math.max(parent.clientHeight, rect.height, window.innerHeight, 1)
      canvas.width = w * dpr
      canvas.height = h * dpr
